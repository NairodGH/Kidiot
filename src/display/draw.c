...
{
    Vector2 pos = {0, 0};
    Vector2 size = {wd / strlen(kidiot->first_floor[0]) / 2, height / get_map_size(kidiot->first_floor)};
    Vector2 baby = {kidiot->baby->pos.y * (wd / strlen(kidiot->first_floor[0]) / 2),
        kidiot->baby->pos.x * (height / get_map_size(kidiot->first_floor))};
    Vector2 mom = {kidiot->mom->pos.y * (wd / strlen(kidiot->first_floor[0]) / 2),
